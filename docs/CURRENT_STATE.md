...
Treat Momus as the coordination and evidence repository until product source is intentionally added or an external implementation repository/path is identified and recorded. Do not fabricate implementation commits in this repository.
